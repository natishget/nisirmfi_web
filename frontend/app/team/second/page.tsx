        ...
        <div className="overflow-x-hidden ">
            ...
            >
                ...
                <div className="relative px-5 sm:px-8 lg:px-12 pb-8 pt-32 w-full  flex flex-col items-center justfy-center">
                    ...
                    >
                        <div className="px-3 py-1 rounded-full bg-[#22348A]/5 tracking-widest border border-gray-200 w-fit text-[#22348A] text-xs flex  items-center gap-2">
                            <Users className="w-4 font-mono" /> MEET OUR LEADERSHIP
                        </div>
                        <p className=" text-[#22348A] font-hanken   mb-1 max-w-2xl tracking-wider ">
                            The Minds Shaping the Future of Financial Inclusion
                        </p>
            ...
            {/* ── Stats strip ── */}
            <section className="bg-white border-b border-gray-100 pb-10 pt-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {directors.map((m, i) => (
                ...
                <section className=" max-w-[95%] rounded-full  mx-auto py-20 bg-[#0d1a52] ">
