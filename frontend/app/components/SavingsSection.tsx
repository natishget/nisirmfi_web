...
const savings = [
  {
    ...
    benefits: ["Earn up to 4% p.a.", "Zero minimum balance", "Instant withdrawals"],
    icon: PiggyBank
  },
  {
    title: "Fixed Savings",
    ...
    benefits: ["Industry-leading 7.5% p.a.", "Flexible tenures 6M-5Y", "Premature withdrawal option"],
    icon: Lock
  },
  {
    ...
    benefits: ["Bonus 0.5% interest rate", "Educational expense benefits", "Financial literacy modules"],
    icon: Baby
  },
  {
    title: "Women's Savings",
    tagline: "Designed for her financial independence",
    color: "from-rose-900 to-rose-950",
    border: "border-rose-500/30",
    iconColor: "text-rose-400",
    benefits: ["Exclusive loan discounts", "Free healthcare consultations", "Zero processing fees"],
    icon: Heart
  },
  {
    ...
    benefits: ["Highest interest tier at 8.2%", "Monthly payout options", "Tax-free maturity amounts"],
    icon: Sunset
  }
];
